...
public class MenuParametres extends JDialog
{
	...
	public MenuParametres()
	{
		...
		//on ajoute l'image, le conteneur central et le bouton au conteneur de la fenetre
	...
	{
		return new Parametres(getNbJoueurs(), getNbIA(), getModeDynastie(), getModeEmpireMilieu(), getModeHarmonie(), getModeGrandDuel());
	}
	...
	private boolean checkValues()
	{
		...
		if(total < 2 || total > 4)
		{
			...
			message.showMessageDialog(null, "le nombre de joueurs doit etre compris entre 2 et 4", "impossible de lancer la partie", JOptionPane.INFORMATION_MESSAGE);
			return false;
		}
		return true;
	}
